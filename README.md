...
- **多源并发搜索**：同时检索 arXiv、Semantic Scholar、OpenAlex、PubMed、Europe PMC、INSPIRE-HEP、CORE、NASA ADS 八个学术数据库
...
| 搜索源 | arXiv、Semantic Scholar、OpenAlex、PubMed、Europe PMC、INSPIRE-HEP、CORE、NASA ADS |
...
论文搜索同时检索以下八个学术数据源，全部通过官方开放 API 自行实现：
...
- [x] 自研多源搜索链路（arXiv / Semantic Scholar / OpenAlex / PubMed / Europe PMC / INSPIRE-HEP / CORE / NASA ADS）
