...
### 搜索结果
![搜索结果](docs/images/04_search_results.png)

### 空状态首页
![首页](docs/images/02_empty_state.png)

### 关键词确认
![关键词确认](docs/images/03_keyword_confirm.png)

### 全部结果（含 AI 过滤）
![全部结果](docs/images/05_all_results.png)
...
- **10 源并发搜索**：同时检索 arXiv、Semantic Scholar、OpenAlex、PubMed、Europe PMC、INSPIRE-HEP、CORE、NASA ADS、CrossRef、Google Scholar，并通过 Unpaywall 自动补全开放获取 PDF 链接
