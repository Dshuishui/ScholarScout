...
- **多论文 AI 分析**：勾选 2 篇以上论文，触发全屏分析面板，支持三种模式：
  - **对比分析** — 逐项对比 + 汇总表格
  - **文献综述** — 综合段落 + 可引用格式
  - **研究趋势** — 时序趋势分析
...
### 订阅与邮件推送
- **关键词订阅**：订阅一组关键词，每天 08:00 CST 自动推送新论文邮件
- **订阅管理**：在订阅管理页面开关、删除或测试发送
- **一键订阅**：搜索结果页关键词 chips 旁直接订阅
...
- 论文收藏夹、阅读历史
- 订阅关键词每日邮件推送（08:00 CST）
- 多论文 AI 对比分析 / 文献综述 / 研究趋势
